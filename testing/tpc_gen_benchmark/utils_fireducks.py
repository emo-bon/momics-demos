"""
Benchmarks inspired by fireducks project under Apache License 2.0

This file is a copy of the file queries/fireducks/utils.py from the fireducks project (2025-02-06)
https://github.com/fireducks-dev/polars-tpch/blob/fireducks/queries/fireducks/utils.py

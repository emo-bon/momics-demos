...
This file is a copy of the file queries/polars/utils.py from the fireducks project (2025-02-06)
https://github.com/fireducks-dev/polars-tpch/blob/fireducks/queries/polars/utils.py

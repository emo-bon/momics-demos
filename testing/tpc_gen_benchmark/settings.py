...
This file is a copy of the file queries/pandas/settings.py from the fireducks project (2025-02-06)
https://github.com/fireducks-dev/polars-tpch/blob/fireducks_20250204/settings.py
                                 Apache License
